...
*   **Topic 4:** An innovative nation (not the U.S.) strong in an innovation area, such as energy, biotechnology, or advanced manufacturing, and the innovation area, the institutions in, and elements of the innovation system for that nation. For example: 
    ...
    *   Finland’s IT sector (post-Nokia).
    ...
    You may get some ideas on technologies and companies from the recent MIT-Stanford book _Game Changers_ on energy technologies or read {{% resource_link "17bee3b7-49e2-491a-8fe8-aadbbeb3c811" "their summaries" %}} which have some quick updates on where technologies stand. {{% resource_link "c67203aa-9647-49ba-afb1-30fbddce2564" "DARPA's website" %}} and {{% resource_link "4f988af7-36bd-4eba-8355-2fd6f6f729d3" "ARPA-E's website" %}} will have useful summaries of where their research is going, and EERE’s wesbsite will have additional energy technology ideas—for example, in solar, look at {{% resource_link "93d87184-ef50-4996-ad8e-df8d189545b4" "DOE’s Sunshot" %}}. For nations, you could look at the "Knowledge Economy" series of books issued by the World Bank on particular nations, such as India or China.
